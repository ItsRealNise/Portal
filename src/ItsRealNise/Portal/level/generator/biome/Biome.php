...
namespace ItsRealNise\Portal\level\generator\biome;

use pocketmine\level\biome\HellBiome;
use ItsRealNise\Portal\level\generator\ender\biome\EnderBiome;

/**
 * Class Biome
 * @package ItsRealNise\Portal\level\generator\biome
 */
